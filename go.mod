module github.com/stuttgart-things/stagetime-operator
...
require (
	...
	github.com/stuttgart-things/stageTime-server v0.4.42
	github.com/stuttgart-things/sthingsBase v0.1.35
	github.com/stuttgart-things/sthingsCli v0.1.86
